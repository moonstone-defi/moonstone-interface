...
const FLEXED = {
  ...
  gradient:
    'flex text-high-emphesis transition duration-1000 ease-in-out text-high-emphesis bg-gradient-to-r from-light-purple via-opaque-green to-dark-900 opacity-80 hover:opacity-100 disabled:bg-opacity-80',
}
...
const FILLED = {
  ...
  gradient:
  'w-full text-high-emphesis transition duration-1000 ease-in-out text-high-emphesis bg-gradient-to-r from-light-purple via-opaque-green to-dark-900 opacity-80 hover:opacity-100 disabled:bg-opacity-80',
}
...
const OUTLINED = {
  ...
  gradient:
    'border border-transparent border-gradient-r-dark-900 opacity-80 hover:opacity-100 disabled:bg-opacity-100 disabled:border-dark-800 disabled:bg-none disabled:bg-dark-700',
}
